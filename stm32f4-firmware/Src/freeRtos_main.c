...
int main_(void)
{
  ...
  // Thread 1 definition 
  osThreadDef(LED3, LED_Thread1, osPriorityNormal, 0, 4*1024);
  
  // Thread 2 definition 
  osThreadDef(LED4, LED_Thread2, osPriorityNormal, 0,4*1024);// configMINIMAL_STACK_SIZE);
...
static void LED_Thread1(void const *argument)
{
  ...
  for(;;)
  {
    ...
    // Resume Thread 2 
    //    osThreadResume(LEDThread2Handle);   TODO uncoment 
  }
}
